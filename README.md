...
> 사람들을 행복하게 하는 서비스를 개발하고 싶습니다. <br>
> 현재 [블로그](https://blog.naver.com/aa991102)를 통해 개발&일상을 기록하고 있습니다. <br>
...
### 💻 프로젝트 기록
> ```2021.04 ~ 현재``` [Myver](https://github.com/aa991102/myver) : 네이버 클론 사이트 개발 프로젝트(개인) <br>
